                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        TextButton(
                            onPressed: (){},
                            child: const Text('Create Account', style: TextStyle(fontSize: 12, color: Color(0xFFBEBEBE)),)
                        ),
                        TextButton(
                            onPressed: (){},
                            child: const Text('Forget Password', style: TextStyle(fontSize: 12, color: Color(0xFFBEBEBE)),)
                        ),
                      ],
                    )
                  ],
